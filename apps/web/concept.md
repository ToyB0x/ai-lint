...
近年、Clineのような大規模言語モデル（LLM）を活用した開発プロセスが急速に普及しています。この新しい開発パラダイムにおいて、AIの挙動を効果的に制御することが不可欠となっています。

::: info AI-Lintとは
AI-Lintは、開発エコシステム全体でAIの挙動を制御するための包括的なプラットフォームです。従来のコードリンターがコードの品質管理に焦点を当てていたのに対し、AI-Lintはその概念を拡張し、コード、ドキュメント、開発フロー、そしてLLMとの対話まで、あらゆる側面で一貫した品質と効率を実現します。

**AIがあなたの標準に合わせる、その逆ではありません。** コード規約、ドキュメント標準、開発プロセス、LLMとの対話方法まで、あらゆる側面でAIを組織の規約に適応させることができます。
:::
